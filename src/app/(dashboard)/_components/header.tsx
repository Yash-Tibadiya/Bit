...
export function Header() {
  return (
    <>
      ...
      >
        <div
          className="screen-line-before screen-line-after mx-auto flex h-12 items-center justify-between gap-2 border-x border-edge px-2 after:z-1 after:transition-[background-color] sm:gap-4 md:max-w-7xl"
      ...
      <div className="max-w-screen overflow-x-hidden px-2 relative">
        <div className="mx-auto md:max-w-7xl relative">
          <div
            className={cn(
              "h-8 px-2",
              "screen-line-after",
